...
export default function registerCopyCommand(program: Command, stax: Stax) {
  program.command('copy')
    ...
    .option('-n, --dont-overwrite', 'Don\'t overwrite if file already exists in the container')
    .option('-p, --prompt', 'Prompt to overwrite if file already exists in the container')
